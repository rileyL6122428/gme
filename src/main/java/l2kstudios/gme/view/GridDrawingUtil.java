...
public class GridDrawingUtil {
	...
	public void drawRectAt(int x, int y) {
		ctx.rect(
				x * SPACE_WIDTH, 
				y * SPACE_HEIGHT, 
				SPACE_WIDTH,
	...
	public void drawRectOutlineRight(int x, int y) {
		ctx.line(
				(x + 1) * SPACE_WIDTH, 
				y * SPACE_HEIGHT, 
				(x + 1) * SPACE_WIDTH, 
	...
	public void drawRectOutlineBottom(int x, int y) {
		ctx.line(
				x * SPACE_WIDTH, 
				(y + 1) * SPACE_HEIGHT, 
				(x + 1) * SPACE_WIDTH, 
	...
	public void drawRectOutlineLeft(int x, int y) {
		ctx.line(
				x * SPACE_WIDTH, 
				y * SPACE_HEIGHT, 
				x * SPACE_WIDTH, 
